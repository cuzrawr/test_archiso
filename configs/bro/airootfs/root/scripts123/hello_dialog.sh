...
WARNING DEFAULT USER IS username WITH PASSWORD 123\n
AND root WITH PASSWORD 123\n"
...
-----------------------------------------------------------------------------\n
archinstall --help: \n
    --config: JSON configuration file or URL\n
    --creds: JSON credentials configuration file\n
